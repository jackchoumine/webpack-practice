...
/******/ 	var hotCurrentHash = "4aa9c189ca8e6a9178e7"; // eslint-disable-line no-unused-vars
...
console.log(button1);
console.log(jquery__WEBPACK_IMPORTED_MODULE_3___default()(button));
jquery__WEBPACK_IMPORTED_MODULE_3___default()(button).on('click', get);

function get() {
  jquery__WEBPACK_IMPORTED_MODULE_3___default.a.get('/getDomainCategory').then(res => {
    console.log(res);
  }).catch(err => {
    console.error(err);
  });
